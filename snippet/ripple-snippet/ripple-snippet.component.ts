...
import {WidgetComponent, WidgetPosition, WidgetStyle} from '../../src/components/core/widget.component';
import {DomService} from '../../src/components/core/dom.service';
import {ArcylicMotionComponent} from '../../src/components/acrylic/arcylic-motion.component';

@Component({
  selector: 'ave-ripple',
  templateUrl: 'snippet/ripple-snippet/ripple.component.html',
  styleUrls: ['snippet/ripple-snippet/ripple.component.scss'],
